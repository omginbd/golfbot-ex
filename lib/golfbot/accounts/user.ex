defmodule Golfbot.Accounts.User do
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:email, :password, :first_name, :last_name, :profile_image])
    |> validate_email()
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Golfbot.Repo)
  ...
  """
  def valid_password?(%Golfbot.Accounts.User{hashed_password: hashed_password}, password)
